...
/**
 * 贝壳小区 ID 映射（真实抓取自 tj.zu.ke.com 各区在租房源页的小区链接）。
 * 用于构建「小区在租房源」直达页：/zufang/c{ID}/，比关键词搜索更精准。
 * 未收录的小区回退到关键词搜索格式。
 */
export const BEIKE_COMMUNITY_IDS: Record<string, string> = {
  丁字沽十三段: 'c1211099789024',
  七段大楼: 'c2811051489305',
  万科民和巷: 'c1211099886878',
  万科金域华府C区: 'c1211062801725',
  万顺空港融和广场雅仕阁公寓: 'c1211100398287',
  三乐里: 'c1211045942434',
  三友里: 'c1211045942757',
  三和温泉花园地利园: 'c1211045609294',
  世昌里: 'c1211045943236',
  东亚风尚国际: 'c1211063466567',
  东升里小区: 'c2811051685228',
  东和家园: 'c1211045531447',
  东瑞家园: 'c1211045427281',
  中嘉花园秋水苑: 'c1211045458790',
  中国铁建国际城诗景凤苑: 'c1220036041643844',
  中国铁建国际城诗景雅苑: 'c1211063578234',
  中山门四号路: 'c2811051311317',
  中海和平之门: 'c12000000025089',
  中海寰宇天下: 'c126874898902854',
  中环福境: 'c1211100197260',
  临月里: 'c1211045569058',
  丽瑞华庭: 'c12000000002351',
  义佳花园: 'c1213282408934800',
  义兴南里: 'c1211045276733',
  九和府: 'c1220035807505782',
  云阳西里: 'c1211045224265',
  五一阳光皓日园: 'c1211045790698',
  任贤里: 'c1211045714806',
  众诚里: 'c1211045958862',
  健全里: 'c1211046051594',
  元兴新里: 'c1211045478573',
  先锋公寓: 'c2811054442419',
  光华巷: 'c1211045876364',
  军丽园: 'c1220030299029924',
  凤园北里: 'c1211045240084',
  凤园南里: 'c1211045241818',
  北宸正荣府: 'c1220044685786991',
  北洋花园东悦里: 'c1211045869016',
  华侨城善水苑: 'c12000000077664',
  华润中央公园: 'c1211047946136',
  华润橡树湾仰润轩: 'c1220053942075706',
  华润橡树湾茗润轩: 'c1220055476330878',
  华润紫阳里: 'c1211063496714',
  南华里: 'c2811055860794',
  双湖花园: 'c1211045629425',
  双街新邨: 'c1211063210811',
  吉利花园: 'c1211046438082',
  ...
  名都公寓: 'c1211045117086',
  向荣里: 'c1211046042417',
  和苑康和园: 'c1220028549649057',
  嘉海花园: 'c1211045645004',
  嘉陵南里: 'c1211045205030',
  团圆里: 'c1211046281568',
  国耀上河城: 'c1211099927543',
  城际美景家园: 'c1211045485996',
  大唐盛世: 'c1220024650314709',
  天和丽园: 'c1220075280507675',
  天山·水榭花都: 'c1220036625462205',
  天房崇德园: 'c1211100049229',
  天房意境: 'c1211063886590',
  天房海河湾: 'c1210637271380964',
  天津碧桂园: 'c1211063547194',
  天津东方环球影城: 'c1211100049263',
  天物郁江溪岸: 'c126876315266209',
  太阳城蓝山园: 'c1211045655348',
  奥林匹克花园枫叶苑: 'c1211045379874',
  好美嘉园: 'c1211045555433',
  孚泰公寓: 'c1211045713817',
  宜昌北里: 'c1211045950483',
  宜淞园二期: 'c12000000026853',
  宝翠花都瞰景园: 'c1211045384119',
  富力又一城合安园: 'c1220066402052774',
  富力又一城合畅园: 'c1220076320708587',
  富力合祥园: 'c12000000051998',
  富力合茂园: 'c12000000051999',
  常州里: 'c1211045420113',
  平祥大厦: 'c1211045347777',
  幸福南里: 'c1211046279784',
  广田里: 'c1211045489269',
  建设新街: 'c1211046518634',
  彩丽园: 'c1211045634967',
  德盈里: 'c1220028467853639',
  悦盛园: 'c1211063010489',
  惠安花园: 'c2811054185933',
  惠裕里: 'c2811054209810',
  意境兰庭: 'c1211063034454',
  招商津湾天玺: 'c1211063539846',
  揽城苑: 'c1211100631557',
  昆仑中心: 'c1211061370988',
  明山里: 'c1211045670622',
  星宇花园: 'c129003340672875',
  春华里: 'c1211045459784',
  景福里: 'c1211045471931',
  景观花园: 'c1211046053321',
  曲溪中里: 'c1211045590505',
  月秋里: 'c1211045635559',
  未来城沁雅苑: 'c1220072795343236',
  本溪花园: 'c1211045442256',
  松江东湖小镇: 'c1211100081456',
  松风西里: 'c1211045592451',
  林苑北里: 'c1211045272397',
  欢颜里: 'c1211045431404',
  正源公寓: 'c1211045414252',
  民悦园: 'c12000000041193',
  民畅园: 'c1211045411605',
  民顺里: 'c129528672269170',
  水竹花园: 'c1211045376159',
  汀兰花园: 'c1220045586748369',
  汇园里: 'c1211045685832',
  江川里: 'c1211045258335',
  江门里: 'c1211045476400',
  河怡花园: 'c1211045405799',
  沽上江南: 'c2811055479019',
  泓林园: 'c1220033254346933',
  泗阳里: 'c2811053697605',
  泽园公寓: 'c1211045691377',
  泽天下: 'c1211063765415',
  津铁泽苑: 'c12000000012795',
  海康园: 'c1220032631360768',
  淮盛园: 'c2811052523812',
  源德里: 'c1211045331521',
  潞河园: 'c1211045349173',
  焕玉里: 'c1211045712040',
  ...
  白云里: 'c1211046087443',
  益寿东里: 'c1211045453572',
  盛庭豪景: 'c1220041096829658',
  盛泰嘉园: 'c1211045886201',
  社会山南苑: 'c1211100316902',
  碧春园: 'c1211045387883',
  碧桂园中骏·天寰: 'c1220043405287092',
  祥诚新苑: 'c12000000006406',
  福东里: 'c1211045549020',
  福熙园: 'c1211045819674',
  禾园: 'c2811054544669',
  秋实园: 'c1211045487675',
  ...
  积善里: 'c1211045511976',
  程林东里: 'c1211045563732',
  程林里小区: 'c1211045537902',
  第六田园优仕公寓: 'c1211045778492',
  紫乐广场: 'c1220041406229599',
  红星路178号: 'c1211046962106',
  红波里: 'c1211046020302',
  纯真里社区: 'c1211045835097',
  绮华里: 'c1211045141441',
  绿岛家园: 'c2811052347317',
  聚英里: 'c1211046125360',
  聚龙园: 'c1211063196397',
  芳园里: 'c1211045682897',
  荣庆园: 'c1211046230957',
  荣翔园: 'c1216999738542524',
  蓝光芙蓉公馆: 'c1220043344477927',
  融创东岸名郡: 'c1212374975196623',
  融创星河和平印: 'c1220027651672675',
  融创星耀五洲: 'c1211100196941',
  融创臻园: 'c1214398846939468',
  西关北里: 'c1211046026520',
  西楼北里: 'c1211045466604',
  詹滨里: 'c1211047723600',
  诚信里小区: 'c1220030712597452',
  路劲赞成: 'c1220040760239836',
  达园: 'c2811054298852',
  郑业里: 'c1211046491275',
  金厦里: 'c1211045266264',
  金地艺境: 'c1211099967876',
  金尚家园: 'c1211045707416',
  金才园: 'c1220025580664445',
  金水畔家园: 'c1211045707652',
  金湾花园: 'c1211045565921',
  金筑家园: 'c1211047798427',
  金钟桥: 'c2811052371977',
  金隅悦城茗香苑: 'c1220045275330481',
  阳光100西园: 'c1211045377829',
  隆升家园: 'c12000000015456',
  隆成家园: 'c1220022868988758',
  雅居乐御宾府: 'c1220035091130901',
  雅致里: 'c1211046808737',
  靖泰里: 'c1211045434817',
  首创城: 'c1211047786024',
  香邑国际: 'c1211047061947',
